...
function CreatePost() {
    ...
    return ( 
        <div className="relative bg-gray-800 p-5 my-auto outline-none rounded-2xl shadow-inner shadow-gray-900 w-[50%] mx-auto overflow-y-scroll no-scrollbar">
            ...
            <form method="post" className="w-[80%] mx-auto flex flex-col mt-8" onSubmit={(e)=>handleSubmit(e)}>
                ...
                <div className="w-full text-center">
                    <input type="submit" name="submit" id="submit" className="w-24 ml-8 inline-block rounded-full p-1 font-bold font-serif bg-gray-700 text-blue-500 cursor-pointer hover:shadow-inner hover:shadow-gray-800 active:animate-bounce" value="Save"/>
