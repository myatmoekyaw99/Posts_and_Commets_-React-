...
function EditUser() {
    ...
    return (  
        <div className="bg-blue-400 p-5 mb-4 outline-none ring-1 ring-gray-500 rounded-2xl shadow-inner shadow-black  w-[40%] mt-2 mx-auto hover:ring-2 overflow-scroll no-scrollbar">
            <h1 className="mt-3 text-center text-white text-2xl bg-clip-text contrast-200 font-bold">Edit Profile</h1>
            <form className="w-[80%] mt-2 mx-auto flex flex-col" onSubmit={(e)=>handleSubmit(e)}>
                    ...
                    <div className="flex flex-row">
                        <input type="submit" name="submit" id="submit" className="px-6 py-1 mx-auto mt-3 inline-block rounded-lg font-md font-serif bg-gray-800 text-blue-400 cursor-pointer shadow-sm shadow-gray-800 hover:ring-2 hover:ring-white " value="Update"/>
                        <button type="reset" name="cancel" id="cancel" className="px-6 py-1 mx-auto mt-3 inline-block rounded-lg font-md font-serif bg-gray-900 text-white border-gray-800 border hover:ring-2 hover:ring-white active:animate-bounce" onClick={()=>{
